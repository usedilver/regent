...
{
  "title": "…",           // título corto (≤70 chars) que describe LA TAREA en sí, nunca la meta-orden ("crea una tarea…" NO es un título). "" en modo actualización, y también "" (con todo lo demás null/vacío) si el mensaje NO pide una tarea — saludo, charla, o una PREGUNTA ("¿por qué…?", "¿cómo funciona…?", "¿dónde está…?", "¿qué hace…?"): una pregunta se responde, no se convierte en tarea, aunque hable de un error; solo es tarea si piden hacer, arreglar, crear o revisar algo. En ese caso contesta solo con "reply".
